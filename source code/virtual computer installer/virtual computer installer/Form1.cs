...
namespace virtual_computer_installer
{
    public partial class Form1 : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                client.DownloadFile("https://github.com/intel/haxm/releases/download/v7.7.0/haxm-windows_v7_7_0.zip", @"C:\temp\IntelHaxm.zip");
            }
            ...
            using (var client = new WebClient())
            {
                client.DownloadFile("https://qemu.weilnetz.de/w64/qemu-w64-setup-20211215.exe", @"C:\temp\qemu.exe");
            }
